...
namespace Suplex.Wpf
{
	...
	public class SplxBorder : Border, IValidationContainer, ILogicalChildrenHost
	{
			...
			: base()
		{
			...
			//this.Diag_Setup();
			DefaultStyleKeyProperty.OverrideMetadata( typeof( SplxBorder ), new FrameworkPropertyMetadata( typeof( SplxBorder ) ) );
		}
		...
		{
			this.Child = control as System.Windows.UIElement;
		}
