...
namespace Suplex.WinForms
{
	...
	[ToolboxItem(true)]
	[ToolboxBitmap(typeof(Suplex.WinForms.SplxSynchronizationManager), "Resources.sSynchronizationManager.png")]
	...
	public class SplxSynchronizationManager : Suplex.Wpf.SplxSecureManagerBase, ISynchronizationManager
	{
