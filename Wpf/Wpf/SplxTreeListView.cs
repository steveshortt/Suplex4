...
{
	public class SplxTreeListView : TreeView
	{
		private GridViewColumnCollection _columns = new GridViewColumnCollection();

		static SplxTreeListView()
		{
			//DefaultStyleKeyProperty.OverrideMetadata( typeof( SplxTreeListView ), new FrameworkPropertyMetadata( typeof( SplxTreeListView ) ) );
		}

		protected override DependencyObject GetContainerForItemOverride()
		{
			return new SplxTreeListViewItem();
		}

		protected override bool IsItemItsOwnContainerOverride(object item)
		{
			return item is SplxTreeListViewItem;
		}
	...
	//{
	//    public static int Level(this TreeViewItem level)
	//    {
	//        if( level == -1 )
	//        {
	//            SplxTreeListViewItem parent = ItemsControl.ItemsControlFromItemContainer( this ) as TreeViewItem;
	...
	public class SplxTreeListViewItem : TreeViewItem
	{
		private int _level = -1;

		static SplxTreeListViewItem()
		{
			//DefaultStyleKeyProperty.OverrideMetadata( typeof( SplxTreeListViewItem ), new FrameworkPropertyMetadata( typeof( SplxTreeListViewItem ) ) );
		}
		...
		public int Level
		{
			get
			{
				if( _level == -1 )
				{
					SplxTreeListViewItem parent = ItemsControl.ItemsControlFromItemContainer( this ) as SplxTreeListViewItem;
