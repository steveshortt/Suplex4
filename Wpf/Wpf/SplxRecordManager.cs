...
namespace Suplex.Wpf
{
	...
	[ToolboxItem( true ), ToolboxBitmap( typeof( Suplex.Wpf.SplxRecordManager ), "Resources.sRecordManager.gif" )]
	...
	public class SplxRecordManager : Suplex.Wpf.SplxSecureManagerBase, IRecordManager, INotifyPropertyChanged
	{
		...
		[Browsable( false )]
		public bool HasInsertUpdateRight { get { return this.HasInsertRight && this.HasUpdateRight; } }
		[Browsable( false )]
		public bool HasInsertOrUpdateRight { get { return this.HasInsertRight || this.HasUpdateRight; } }
		[Browsable( false )]
		public bool HasDeleteRight { get { return _sr[AceType.Record, RecordRight.Delete].AccessAllowed; } }
		[Browsable( false )]
		public bool HasInsertUpdateDeleteRight { get { return this.HasInsertRight && this.HasUpdateRight && this.HasDeleteRight; } }
		[Browsable( false )]
		public bool HasInsertOrUpdateOrDeleteRight { get { return this.HasInsertRight || this.HasUpdateRight || this.HasDeleteRight; } }

		public void NotifySecurityResultsChanged()
		{
			this.OnPropertyChanged( "HasListRight" );
			this.OnPropertyChanged( "HasSelectRight" );
			this.OnPropertyChanged( "HasInsertRight" );
			this.OnPropertyChanged( "HasUpdateRight" );
			this.OnPropertyChanged( "HasInsertUpdateRight" );
			this.OnPropertyChanged( "HasInsertOrUpdateRight" );
			this.OnPropertyChanged( "HasDeleteRight" );
			this.OnPropertyChanged( "HasInsertUpdateDeleteRight" );
			this.OnPropertyChanged( "HasInsertOrUpdateOrDeleteRight" );
		}
