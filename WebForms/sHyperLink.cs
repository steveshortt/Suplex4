...
namespace Suplex.WebForms
{
	...
	public class sHyperLink : System.Web.UI.WebControls.HyperLink, IValidationControl, IWebExtra
	{
		...
		//{
		//    _sa.AuditAction( AuditType.ControlDetail, null, "Clicked." );

		//    if( _sr[AceType.UI, UIRight.Operate].AccessAllowed )
		//    {
		//        vr = _va.ProcessEvent( this.Text, ControlEvents.Click, true );
		//        base.OnClick( e );
		//    }
		//}
		...
		//        String.Format( "OnCommand. Name: {0}, Argument: {1}.", e.CommandName, e.CommandArgument.ToString() ) );

		//    if( _sr[AceType.UI, UIRight.Operate].AccessAllowed )
		//    {
		//        vr = _va.ProcessEvent( this.Text, ControlEvents.Command, true );
		//        base.OnCommand( e );
		//    }
		//}
