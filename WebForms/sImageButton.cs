...
namespace Suplex.WebForms
{
	...
	[EventBindings( EventBindingsAttribute.BaseEvents.WebForms, ControlEvents.Click | ControlEvents.Command )]
	public class sImageButton : System.Web.UI.WebControls.ImageButton, IValidationControl, ISecureControl, IWebExtra
	{
		...
		public ValidationResult ProcessValidate(bool processFillMaps)
		{
			...
			if( this.Enabled )
			{
				vr = _va.ProcessEvent( this.ImageUrl, ControlEvents.Validating, processFillMaps );
			}
			return vr;
		}
		...
		protected override void OnClick(ImageClickEventArgs e)
		{
			...
			{
				_va.ProcessEvent( this.ImageUrl, ControlEvents.Click, true );
				base.OnClick( e );
			}
		}
		...
		protected override void OnCommand(CommandEventArgs e)
		{
			...
			if( _sr[AceType.UI, UIRight.Operate].AccessAllowed )
			{
				_va.ProcessEvent( this.ImageUrl, ControlEvents.Command, true );
				base.OnCommand( e );
			}
		}
		...
		private void OnEnabledChanged()
		{
			...
			{
				_va.ProcessEvent( this.ImageUrl, ControlEvents.EnabledChanged, true );
			}
		}
		...
		private void OnVisibleChanged()
		{
			...
			{
				_va.ProcessEvent( this.ImageUrl, ControlEvents.VisibleChanged, true );
			}
		}
		#endregion
