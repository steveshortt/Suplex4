...
namespace Suplex.WebForms
{
	...
	public class sLabel : System.Web.UI.WebControls.Label, IValidationControl, IWebExtra
	{
		...
		private bool _renderAccessKeyUnderline = false;
		...
		public bool RenderAccessKeyUnderline
		{
			get { return _renderAccessKeyUnderline; }
			set { _renderAccessKeyUnderline = value; }
		}

		protected override void Render(HtmlTextWriter writer)
		{
			if( _renderAccessKeyUnderline )
			{
				this.Text = RenderUtil.RenderAccessKey( this.Text, this );
			}
