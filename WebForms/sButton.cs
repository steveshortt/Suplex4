...
namespace Suplex.WebForms
{
	...
	public class sButton : System.Web.UI.WebControls.Button, IValidationControl, IWebExtra
	{
		...
		public override bool Visible
		{
			...
			set
			{
				if( _preInit || _sr[AceType.UI, UIRight.Visible].AccessAllowed )
				{
		...
		public override bool Enabled
		{
			...
			set
			{
				if( _preInit || _sr[AceType.UI, UIRight.Enabled].AccessAllowed )
				{
