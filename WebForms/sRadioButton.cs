...
namespace Suplex.WebForms
{
	...
	[EventBindings( EventBindingsAttribute.BaseEvents.WebForms, ControlEvents.CheckChanged )]
	public class sRadioButton : System.Web.UI.WebControls.RadioButton, IValidationControl, IWebExtra
	{
		...
		public ValidationResult ProcessValidate(bool processFillMaps)
		{
			...
			if( this.Enabled )
			{
				vr = _va.ProcessEvent( this.Checked.ToString(), ControlEvents.Validating, processFillMaps );
			}
			return vr;
		}
		...
		{
			_sa.AuditAction( AuditType.ControlDetail, null, "CheckedChanged.", false );

			if( _sr[AceType.UI, UIRight.Operate].AccessAllowed )
			{
				_va.ProcessEvent( this.Checked.ToString(), ControlEvents.CheckChanged, true );
		...
		private void OnEnabledChanged()
		{
			...
			{
				_va.ProcessEvent( this.Checked.ToString(), ControlEvents.EnabledChanged, true );
			}
		}
		...
		private void OnVisibleChanged()
		{
			...
			{
				_va.ProcessEvent( this.Checked.ToString(), ControlEvents.VisibleChanged, true );
			}
		}
		#endregion
