...
namespace Suplex.WinForms
{
	...
	[ToolboxItem(true)]
	[ToolboxBitmap(typeof(Suplex.WinForms.sSynchronizationManager), "Resources.sSynchronizationManager.png")]
	...
	public class sSynchronizationManager : Suplex.WinForms.sSecureManagerBase, ISynchronizationManager
	{
		...
		public sSynchronizationManager() : base( Properties.Resources.SynchronizationManagerImage )
		{
