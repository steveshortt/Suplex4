...
namespace Suplex.WinForms
{
	...
	/// </summary>
	[ToolboxItem( true ), ToolboxBitmap( typeof( ToolStripLabel ) )]
	[EventBindings( EventBindingsAttribute.BaseEvents.WinForms, ControlEvents.CheckStateChanged )]
	public class sToolStripLabel : System.Windows.Forms.ToolStripLabel, ISecureControl
	{
