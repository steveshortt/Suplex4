...
namespace Suplex.WinForms
{
	...
	/// </summary>
	[ToolboxItem( true ), ToolboxBitmap( typeof( ToolStripComboBox ) )]
	[EventBindings( EventBindingsAttribute.BaseEvents.WinForms, ControlEvents.CheckStateChanged )]
	public class sToolStripComboBox : System.Windows.Forms.ToolStripComboBox, ISecureControl
	{
		...
		public sToolStripComboBox() : base()
		{
