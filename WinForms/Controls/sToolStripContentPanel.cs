...
namespace Suplex.WinForms
{
	...
	/// </summary>
	[ToolboxItem( true ), ToolboxBitmap( typeof( ToolStripContentPanel ) )]
	[EventBindings( EventBindingsAttribute.BaseEvents.WinForms, ControlEvents.CheckStateChanged )]
	public class sToolStripContentPanel : System.Windows.Forms.ToolStripContentPanel, ISecureContainer
	{
		...
		public sToolStripContentPanel() : base()
		{
