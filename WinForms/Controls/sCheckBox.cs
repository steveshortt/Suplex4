...
namespace Suplex.WinForms
{
	...
	/// </summary>
	[ToolboxItem( true ), ToolboxBitmap( typeof( CheckBox ) )]
	[EventBindings( EventBindingsAttribute.BaseEvents.WinForms, ControlEvents.CheckStateChanged )]
	public class sCheckBox : System.Windows.Forms.CheckBox, IValidationControl, ISecureControl
	{
		...
		public sCheckBox() : base()
		{
			...
			_va = new ValidationAccessor( this, TypeCode.Boolean );
		}
		...
		{
			_sa.AuditAction( AuditType.ControlDetail, null, "CheckStateChanged.", false );
			
			if( _sr[AceType.UI, UIRight.Operate].AccessAllowed )
			{
				_va.ProcessEvent( this.CheckState.ToString(), ControlEvents.CheckStateChanged, true );
		...
		{
			_va.ProcessEvent( this.CheckState.ToString(), ControlEvents.Enter, true );
			base.OnEnter( e );
		}

		protected override void OnLeave(EventArgs e)
		{
			_va.ProcessEvent( this.CheckState.ToString(), ControlEvents.Leave, true );
			base.OnLeave( e );
		}
		...
		protected override void OnEnabledChanged(EventArgs e)
		{
			...
			{
				_va.ProcessEvent( this.CheckState.ToString(), ControlEvents.EnabledChanged, true );
		...
		protected override void OnVisibleChanged(EventArgs e)
		{
			...
			{
				_va.ProcessEvent( this.CheckState.ToString(), ControlEvents.VisibleChanged, true );
