...
namespace Suplex.WinForms
{
	...
	/// </summary>
	[ToolboxItem( true ), ToolboxBitmap( typeof( sToolStripDropDownButton ) )]
	[EventBindings( EventBindingsAttribute.BaseEvents.WinForms, ControlEvents.CheckStateChanged )]
	public class sToolStripDropDownButton : System.Windows.Forms.ToolStripDropDownButton, ISecureControl
	{
		...
		public sToolStripDropDownButton() : base()
		{
